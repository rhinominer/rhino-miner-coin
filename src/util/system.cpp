...
const char * const BITCOIN_CONF_FILENAME = "rhino.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Rhino";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Rhino";
#else
    // Unix
    return pathRet / ".rhino";
#endif
#endif
}
