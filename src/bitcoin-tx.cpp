...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " rhino-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  rhino-tx [options] <hex-tx> [commands]  Update hex-encoded Rhino Miner Coin transaction\n" +
            "or:     rhino-tx [options] -create [commands]   Create hex-encoded Rhino Miner Coin transaction\n" +
            "\n";
